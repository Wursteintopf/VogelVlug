...
const Projects: React.FC = () => {
  return (
    <ProjectContainer maxWidth={1000}>
      ...
      <ProjectCard id='youlys' color='#010348' href='https://youlys.de' img={youlys}>
      ...
      <ProjectCard id='sahakom' color='#447604' href='https://sahakom.org' img={sahakom}>
      ...
      <ProjectCard id='ultrafood' color='#454545' href='https://www.instagram.com/p/Bm3hJWAFEw6/' img={ultrafood}>
