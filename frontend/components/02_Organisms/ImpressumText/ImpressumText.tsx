...
export const ImpressumContainer = styled(Container)`
  margin-bottom: 260px;
`

const ImpressumText: React.FC = () => {
  return (
    <ImpressumContainer maxWidth={1000}>
      ...
      Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit, zu finden unter:
      http://ec.europa.eu/consumers/odr<br /><br />
      ...
      Die Inhalte dieser Seiten wurden mit größter Sorgfalt erstellt. Für ihre Richtigkeit, Vollständigkeit und 
      Aktualität kann jedoch keine Gewähr übernommen werden. Als Diensteanbieter sind wir gemäß § 7 Abs.1 TMG für eigene 
      ...
      Rechtsverletzungen werden diese Inhalte umgehend entfernt.<br />
      ...
      gekennzeichnet, sofern vom Urheberrecht verlangt. Sollten Sie trotzdem auf eine Urheberrechtsverletzung aufmerksam 
      werden, bitten wir um einen entsprechenden Hinweis. Bei Bekanntwerden von Rechtsverletzungen werden derartige 
